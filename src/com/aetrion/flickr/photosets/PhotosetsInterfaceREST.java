...
/**
 * REST Interface for working with photosets.
 *
 * @author Anthony Eden
 */
public class PhotosetsInterfaceREST extends PhotosetsInterface{
    
    private String apiKey;
    private REST restInterface;
    
    public PhotosetsInterfaceREST(String apiKey, REST restInterface) {
        this.apiKey = apiKey;
