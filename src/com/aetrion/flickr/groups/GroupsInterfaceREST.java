...
/**
 * REST Interface for working with Flickr Groups.
 *
 * @author Anthony Eden
 */
public class GroupsInterfaceREST extends GroupsInterface{
    
    private String apiKey;
    private REST restInterface;
    
    public GroupsInterfaceREST(String apiKey, REST restInterface) {
        this.apiKey = apiKey;
